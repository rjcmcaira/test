<?php
    ...
    $curso = new Curso();
    $curdx = $curso -> get_curso_destacado();

    $curx = $curso -> get_curso();
    //print_r($curx);
?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 align-self-center">
                        ...
                        <h3 class="mb-20"> Bienvenidos a mi aplicativo web</h3>
        ...
        <div class="container">
            ...
            <div class="footer-copy-right pt-30 mt-20 wow fadeInUp animated">
                ...
                <p class="float-md-right font-small text-muted">
                    Design by <a href="#" target="_blank">AliThemes</a> | All rights reserved
                </p>
            </div>
        </div>
    </footer>
